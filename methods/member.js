...
const memberByBlood = async (req, res) => {
  try {
   ...
   let  mukhiyaBlood = await sequelize.query(`SELECT * FROM mukhiyas where blood_group = '${blood}'`)
    mukhiyaBlood = mukhiyaBlood[0] ? mukhiyaBlood[0] : [];
    console.log("======mukhiyaBlood=====",mukhiyaBlood)
...
module.exports = { unMarriedMember, allVillage, memberByBlood , getImage};
